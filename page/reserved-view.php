...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a style="float: left; padding-top: 14px; margin-right: -30px; padding-left: 10px; color: white;" href="index.php?page=reserved"><i class="material-icons">arrow_back</i></a>
