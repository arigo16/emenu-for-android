...
<html>
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-white w3-text-grey w3-card-4">
            ...
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>+62 89630963190</p>
            <hr>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <p>Bekerja sebagai programmer web developer menggunakan bahasa pemrograman Angular 6.</p>
            <hr>
            </div>
        </div>
